                ...
                case '1' :
                    ...
                    **/
                    ...
                    String keyinput;
                     ...
                     /**
                     Loop som forts�tter indtil et ikke-eksisterende medlemsID v�lges
                     **/
                        do {
                        ...
                        /**
                        Nogle if-s�tninger for at undg� sp�rgsm�l, der allerede er udelukket
                        **/
                    ...
                    for (int i = 0; i < editSearchListLength; i++) {
                        if (memberList.get(i).getMemberID()==(editSearch)) {
                            ...
                            while(editMemberLoop == true) {
                                ...
                                /**
                                Switch til at v�lge hvilken egenskab, der skal redig�res
                                **/
                                switch(editMember) {
                                    case '1' :
